...
namespace ByteDev.Domain.UnitTests
{
    ...
    public class UkPostcodeTest
    {
        ...
        public class Constructor
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => new UkPostcode(null));
            }
            ...
            {
                Assert.Throws<ArgumentException>(() => new UkPostcode(string.Empty));
            }

            [Test]
            public void WhenLengthLessThanFiveChars_ThenThrowException()
            {
                Assert.Throws<ArgumentException>(() => new UkPostcode("A99A"));
            }

            [Test]
            public void WhenLengthMoreThanSevenChars_ThenThrowException()
            {
                Assert.Throws<ArgumentException>(() => new UkPostcode("AA9A9AAA"));
            }
            ...
            {
                Assert.Throws<ArgumentException>(() => new UkPostcode(postCode));
            }
