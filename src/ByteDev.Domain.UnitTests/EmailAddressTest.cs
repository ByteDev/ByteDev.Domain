...
namespace ByteDev.Domain.UnitTests
{
    ...
    public class EmailAddressTest
    {
        ...
        public class Constructor
        {
            ...
            {
                Assert.Throws<ArgumentException>(() => new EmailAddress("someone"));
            }

            [Test]
            public void WhenAddressHasNoUser_ThenThrowException()
            {
                Assert.Throws<ArgumentException>(() => new EmailAddress("@somewhere.com"));
            }
            ...
            {
                Assert.Throws<ArgumentException>(() => new EmailAddress("a@somewhere"));
            }

            [Test]
            public void WhenAddressHasMoreThanOneAt_ThenThrowException()
            {
                Assert.Throws<ArgumentException>(() => new EmailAddress("someone@@somewhere.com"));
            }
