...
namespace ByteDev.Domain.UnitTests
{
    ...
    {
        [TestFixture]
        public class CelsiusToFahrenheit : TemperatureConvertTest
        {
            [TestCase(-1, 30.2d)]
            [TestCase(0, 32d)]
            [TestCase(1, 33.8d)]
        ...
        [TestFixture]
        public class CelsiusToKelvin : TemperatureConvertTest
        {
            [TestCase(-1, 272.15d)]
            [TestCase(0, 273.15d)]
            [TestCase(1, 274.15d)]
        ...
        [TestFixture]
        public class FahrenheitToCelsius : TemperatureConvertTest
        {
        ...
        [TestFixture]
        public class FahrenheitToKelvin : TemperatureConvertTest
        {
        ...
        [TestFixture]
        public class KelvinToCelsius : TemperatureConvertTest
        {
            [TestCase(-1, -274.15d)]
            [TestCase(0, -273.15d)]
            [TestCase(1, -272.15d)]
        ...
        [TestFixture]
        public class KelvinToFahrenheit : TemperatureConvertTest
        {
